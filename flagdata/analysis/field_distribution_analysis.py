...
openai.api_key = '40de0393c800428a9984dd350659ffef'  # os.getenv("AZURE_OPENAI_KEY")
openai.api_base = 'https://llm-sft.openai.azure.com/'  # os.getenv("AZURE_OPENAI_ENDPOINT") # your endpoint should look like the following https://YOUR_RESOURCE_NAME.openai.azure.com/

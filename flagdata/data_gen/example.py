...
import copy
import sys
sys.path.append('/home/baaidial/duli/sft_aug/gpt4_n')
...
openai.api_key = '314c94b92ba04eda88ad930d51c1ae69'  # os.getenv("AZURE_OPENAI_KEY")
openai.api_base = 'https://baaiaquila.openai.azure.com/'  #os.getenv("AZURE_OPENAI_ENDPOINT") # your endpoint should look like the following https://YOUR_RESOURCE_NAME.openai.azure.com/
...
wkdir = "/home/baaidial/duli/sft_aug/dat/aug_dat/revising"
output_path = 'generated_dat.jsonl'

example_ls = ['我小时候吃虾，然后出现过敏反应。几年后，我吃了带有章鱼的虾，然后出现了更严重的过敏反应。每次我去那些有强烈虾味的餐馆，我都会一贯性地出现过敏反应。这可以推断出：', 
